...
class KalmanFilterGUI(QWidget):
    ...
    def plot_measurements(self, tracks, plot, plot_type, selected_track_ids=None):
        for track in tracks:
            ...
            if plot_type == "Range vs Time":
                plot.plot(times, measurements_x, pen=None, symbol='o', symbolSize=10, name=f'Track {track["track_id"]} Measurement X')
                plot.plot(Sf_times, Sf_x, pen='r', symbol=None, name=f'Track {track["track_id"]} Sf X')
                plot.setLabel('left', 'X Coordinate')
            elif plot_type == "Azimuth vs Time":
                plot.plot(times, measurements_y, pen=None, symbol='o', symbolSize=10, name=f'Track {track["track_id"]} Measurement Y')
                plot.plot(Sf_times, Sf_y, pen='r', symbol=None, name=f'Track {track["track_id"]} Sf Y')
                plot.setLabel('left', 'Y Coordinate')
            elif plot_type == "Elevation vs Time":
                plot.plot(times, measurements_z, pen=None, symbol='o', symbolSize=10, name=f'Track {track["track_id"]} Measurement Z')
    ...
    def plot_ppi(self, tracks, plot):
        ...
        for track in tracks:
            ...
            # PPI plot (x vs y)
            plot.plot(x_coords, y_coords, pen=None, symbol='o', symbolSize=10, name=f"Track {track['track_id']} PPI")
